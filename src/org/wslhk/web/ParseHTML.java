...
public class ParseHTML {
	public static void main(String[] args){
		//ParseHTML.parseTag("http://www.baidu.com", html, tagname)
	}
...
//	}
	 ...
	 */
	public   static   void   parseTag(String url,String html,String tagname)   throws   ParserException   { 
...
//		  DownFile thisimg=null;
		  for(int i=0;i<list.size();i++){
			...
			//  org.htmlparser.Tag
			  ...
			  System.out.println("src:"+ node.getAttribute("src"));
			  System.out.println("type:"+ node.getAttribute("type"));
			  System.out.println("href:"+ node.getAttribute("href"));
